...
python trainer.py  --config_file=./configs/train_main/  --exp_name misr/srdiff_maxvit_ltae_ckpt --hparams="diff_net_ckpt=/my_data/Results/MISR_JOINT_SRDiff_LCC_HR5_SR4_FLAIR3/results/checkpoints/misr/srdiff_maxvit_ltae_ckpt" --infer
