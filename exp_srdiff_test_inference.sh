...
which python
cd $HOME/MISR_JOINT_SRDiff_LCC_HR5_SR4_FLAIR3
srun python trainer.py --config configs/diffsr_maxvit_ltae.yaml --config_file flair-config-server.yml --exp_name misr/srdiff_highresnet_ltae_ckpt --hparams="cond_net_ckpt=/bigwork/nhgnkany/Results/MISR_JOINT_SRDiff_LCC_HR5_SR4_FLAIR3/results/checkpoints/misr/srdiff_highresnet_ltae_ckpt" --infer
