...
srun python trainer.py --config configs/misr/highresnet_ltae.yaml --config_file flair-config-server.yml --exp_name misr/highresnet_ltae_ckpt --hparams="cond_net_ckpt=/bigwork/nhgnkany/Results/MISR_JOINT_SRDiff_LCC_HR5_SR4_FLAIR3/results/checkpoints/misr/highresnet_ltae_ckpt" --infer
